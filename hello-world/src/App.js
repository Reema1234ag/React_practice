...
import { BindingHandlers, BindingHandlers1, BindingHandlers2, BindingHandlers3, ClassClick } from './youtube classes/BindingHandlers';
import ParentComponent from './youtube classes/ParentComponent';
import {ConditionalRandering,ConditionalRandering1, ConditionalRandering2, ConditionalRandering3} from './youtube classes/ConditionalRandering';
import  { List,List1 } from './youtube classes/List';
import Listkey from './youtube classes/Listkey';
import IndexAsKey from './youtube classes/IndexAsKey';
import CssWays from './youtube classes/CssWays';
import styles from './youtube classes/css.module.css'
import FormHandling from './youtube classes2/FormHandling';
import LifecycleA from './youtube classes2/LifecycleA';
import LifecycleA1 from './youtube classes2/LifecycleA1';
...
function App() {
  return (
    <>
      ...
      <BindingHandlers3/>
      <hr></hr>
      <h1>Methods and props(pass methods to props react component)</h1>
      <ParentComponent/>
      <hr></hr>
      <h1>Conditional Randering</h1>
      <ConditionalRandering/>
      <ConditionalRandering1/>
      <ConditionalRandering2/>
      <ConditionalRandering3/>
      <hr></hr>
      <h1>List Renderding</h1>
      <List/>
      <List1/>
      <hr></hr>
    ...
    <FormHandling/>
    <hr></hr>
    <h1>Life Cycle Hooks in class component</h1>
    <LifecycleA/>
    <LifecycleA1/>
    <hr></hr>
    <Fragment/>
